...
namespace Lab9_BST
{
    ...
    public class EmployeeManagementSystem
    {
        ...
        private void InOrderRecursive(TreeNode? node)
        {
            ...
            InOrderRecursive(node.Left); // Process left
            Console.WriteLine(node.Employee); // Process current
            InOrderRecursive(node.Right); // Process right
        }
